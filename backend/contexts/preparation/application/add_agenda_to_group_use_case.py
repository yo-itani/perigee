...
class AddAgendaToGroupInput:
    """Input DTO for AddAgendaToGroupUseCase."""
...
class AddAgendaToGroupUseCase:
    ...
    async def execute(
        self,
        input_dto: AddAgendaToGroupInput,
    ) -> None:
        """Add an agenda topic to all schedules in the group.

        Args:
            input_dto: Input parameters for adding an agenda to a group.
